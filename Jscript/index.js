...
var arr2 =[
    ...
    arr1.forEach(element => {
        ...
        document.querySelector(".users1").append(tr);
   });
   ...
   arr2.forEach(element => {
    ...
    document.querySelector(".users2").append(tr);
});
...
function show() {
  ...
  document.querySelector(".array3").style.visibility = "visible";
  ...
  arr.forEach(element => {
    ...
    document.querySelector(".users3").append(tr);
